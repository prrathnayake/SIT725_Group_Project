...
} = require("../../middleware/websocket-server/emmiter.js");
...
async function updateEmployee(employee) {
  try {
    ...
    if (employee.userRole && employee.userRole == "Admin") {
      const message = {
        type: "employee_updated",
        message: "Your details has been updated",
      };
      emitMessagebyEmployeeId(updatedEmployee.empId, message);
    } else if (employee.userRole && employee.userRole == "Employee") {
      const message = {
        type: "employee_updated",
        message:
          "Employee ID: " + updatedEmployee.empId + " details has been updated",
      };
